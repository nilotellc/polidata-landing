...
export const metadata: Metadata = {
  ...
  description: "Stop spending 2 hours every day checking Congress.gov. Get automated bill tracking and alerts for advocacy teams starting at $149/month.",
  ...
  openGraph: {
    title: "PoliData - Track Federal Legislation in Real-Time",
    description: "Automated bill tracking for small advocacy teams. Starting at $149/month.",
    type: "website",
